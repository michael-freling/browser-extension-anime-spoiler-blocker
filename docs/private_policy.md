...
- __Application__ refers to Anime Spoiler Blocker, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Anime Spoiler Blocker.
...
Your information, including Personal Data, is processed at the Company's operating offices and in any other places where the parties involved in the processing are located. It means that this information may be transferred to ΓÇö and maintained on ΓÇö computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction.
...
- By visiting this page on our website: [https://github.com/michael-freling/browser-extension-anime-spoiler-blocker/issues](https://github.com/michael-freling/browser-extension-anime-spoiler-blocker/issues)
